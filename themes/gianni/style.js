...
const Style = () => {
  return <style jsx global>{`
    ...
    #theme-gianni a { color: var(--text-secondary); text-decoration: none; transition: color var(--transition-fast); }
    ...
    #theme-gianni .gianni-pill.active {
      color: var(--accent); border-color: rgba(255,92,57,0.25);
    }
    ...
    #theme-gianni .gianni-tag:hover { color: var(--text-secondary); border-color: var(--border-hover); }

    /* ── Timeline ── */
    #theme-gianni .gianni-timeline-dot {
      width: 7px; height: 7px; border-radius: 50%;
      background: var(--text-muted); transition: background var(--transition-fast);
    }
    ...
    #theme-gianni .gianni-sidebar-widget {
      background: var(--bg-surface); border: 1px solid var(--border);
      border-radius: 12px; padding: 16px; transition: all var(--transition-base);
    }
    ...
    #theme-gianni .gianni-toc-item {
      ...
      border-left: 1px solid var(--divider); transition: all var(--transition-fast);
    ...
    #theme-gianni .gianni-glass-input:focus-within .gianni-search-icon { color: var(--accent); }
